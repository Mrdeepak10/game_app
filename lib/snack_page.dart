...
import 'package:games_app/snack_game_over.dart';

class SnackGamePage extends StatefulWidget {
  @override
  _SnackGamePageState createState() => _SnackGamePageState();
}

class _SnackGamePageState extends State<SnackGamePage> with TickerProviderStateMixin {
